...
# 1. Given four real numbers representing cartesian coordinates: (x1,y1),(x2,y2). 
...
print(str(distance(x1,y1,x2,y2)))

# 2. Given a positive real number a and integer n.
# Compute an. Write a function power(a, n) to calculate the results using the function 
...
# 3. Write a function capitalize(lower_case_word) that takes the lower case word and 
# returns the word with the first letter capitalized. Eg., print(capitalize('word')) should print the word Word.
...
print(' '.join(capitalize(i) for i in strng))

# 4. Given a positive real number a and a non-negative integer n. 
...
# 5. Given a sequence of integers that end with a 0. Print the sequence in reverse order.
...
# 6. Given a non-negative integer n, print the nth Fibonacci number. 
